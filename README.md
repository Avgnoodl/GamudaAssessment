...
| **Simulation** | Python + SQLAlchemy | 30 % chance per poll to create goal/yellow/sub, auto‑finish at 90′ |
...
While there wasn't much time to make the app, I feel like the following imporvements could be made:
...
- **Light theme / theming** – automatic via Vuetify’s presets; improve accessibility. Currenlty only on Dark Mode.
